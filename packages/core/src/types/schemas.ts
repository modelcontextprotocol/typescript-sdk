...
export const DiscoverRequestSchema = RequestSchema.extend({
    ...
    // Spec @d494db5c marks params required; SDK defaults to {} so the inferred
    // type matches spec while server-side parsing stays tolerant of pre-2026
    // clients that omit it. Client._send populates params._meta in later commits.
    params: BaseRequestParamsSchema.default({})
});
...
export const PaginatedRequestSchema = RequestSchema.extend({
    // Spec @d494db5c marks params required; see DiscoverRequestSchema note.
    params: PaginatedRequestParamsSchema.default({})
});
