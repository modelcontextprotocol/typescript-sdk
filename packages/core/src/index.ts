...
export * from './shared/handlerRegistry.js';
export * from './shared/metadataUtils.js';
export * from './shared/plugin.js';
export * from './shared/pluginContext.js';
export * from './shared/progressManager.js';
export * from './shared/protocol.js';
export * from './shared/responseMessage.js';
export * from './shared/stdio.js';
export * from './shared/taskClientPlugin.js';
export * from './shared/taskPlugin.js';
