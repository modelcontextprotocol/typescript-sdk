...
export abstract class Protocol<ContextT extends BaseContext> {
    ...
    constructor(private _options?: ProtocolOptions) {
        ...
        // notifications/{cancelled,progress} are handled by StreamDriver internally
        // (abort + progress callback) and then also dispatched here so user-registered
        // handlers still fire (parity with the pre-decomposition Protocol).
