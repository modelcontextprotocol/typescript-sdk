...
export interface SSEServerTransportOptions {
     ...
     * @deprecated Use the `hostHeaderValidation` middleware from `@modelcontextprotocol/express` instead,
     * or use `createMcpExpressApp` from `@modelcontextprotocol/express` which includes localhost protection by default.
     */
    allowedHosts?: string[];
