 ...
 * @internal
 */
type ShttpRequestEnv = RequestEnv & {
    _transportExtra?: MessageExtraInfo;
    /** Per-session capabilities from {@linkcode SessionCompat}; consumed by `Server.buildContext`. */
    clientCapabilities?: import('@modelcontextprotocol/core').ClientCapabilities;
};
...
export function shttpHandler(
    ...
    async function handleGet(req: Request): Promise<Response> {
        ...
        session.addStreamId(sessionId, streamId, { protected: true });
