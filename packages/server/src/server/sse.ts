...
export interface SSEServerTransportOptions {
     ...
     * @deprecated Use the `hostHeaderValidationResponse` helper from `@modelcontextprotocol/server`,
     * or use `createMcpExpressApp` from `@modelcontextprotocol/server-express` which includes localhost protection by default.
     */
    allowedHosts?: string[];
