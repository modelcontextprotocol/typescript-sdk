...
export class McpServer {
    ...
    private _createRegisteredTool(
        ...
        _meta: Record<string, unknown> | undefined,
        handler: ToolCallback<StandardSchemaWithJSON | undefined>
    ): RegisteredTool {
        // Validate tool name according to SEP specification
        validateAndWarnToolName(name);

        // Track current handler for executor regeneration
        let currentHandler: ToolCallback<StandardSchemaWithJSON | undefined> = handler;
        ...
        const registeredTool: RegisteredTool = {
            ...
            update: updates => {
                ...
                if (updates.callback !== undefined) {
                    ...
                    currentHandler = updates.callback as ToolCallback<StandardSchemaWithJSON | undefined>;
                    needsExecutorRegen = true;
                }
