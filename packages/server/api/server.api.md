...
// @public (undocumented)
export const COMPLETABLE_SYMBOL: unique symbol;
...
// @public
export class ExperimentalServerTasks<RequestT extends Request_2 = Request_2, NotificationT extends Notification = Notification, ResultT extends Result = Result> {
...
// @public @deprecated
export class Server<RequestT extends Request_2 = Request_2, NotificationT extends Notification = Notification, ResultT extends Result = Result> extends Protocol<ServerRequest | RequestT, ServerNotification | NotificationT, ServerResult | ResultT> {
