...
/**
 * Demo script showcasing the tool name validation according to SEP: Specify Format for Tool Names
 * 
...
console.log("🔧 MCP Tool Name Validation Demo");
console.log("================================\n");
...
// 4. Invalid tool name (contains spaces)
console.log("❌ Registering tool: 'invalid tool name'");
...
// 5. Invalid tool name (contains parentheses)
console.log("❌ Registering tool: 'test (new api)'");
...
console.log("   • Names with warnings: 2 tools registered with warnings");
console.log("   • Invalid names: 2 tools registered with errors (but still functional)");
console.log("\n💡 Note: All tools were registered successfully despite validation issues.");
console.log("   The validation system issues warnings and errors but doesn't block registration,");
console.log("   ensuring backwards compatibility while encouraging best practices.");
console.log("\n🔍 Check the console output above for detailed validation messages.");