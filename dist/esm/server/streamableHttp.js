...
export class StreamableHTTPServerTransport {
    constructor(options) {
        ...
        this._sessionStorageMode = (_b = options.sessionStorageMode) !== null && _b !== void 0 ? _b : 'memory';
        this._sessionStore = options.sessionStore;
        this._onsessioninitialized = options.onsessioninitialized;
        this._onsessionclosed = options.onsessionclosed;
        this._allowedHosts = options.allowedHosts;
        this._allowedOrigins = options.allowedOrigins;
        this._enableDnsRebindingProtection = (_c = options.enableDnsRebindingProtection) !== null && _c !== void 0 ? _c : false;
        this._retryInterval = options.retryInterval;
        // Validate configuration
        if (this._sessionStorageMode === 'external' && !this._sessionStore) {
            throw new Error('SessionStore is required when sessionStorageMode is "external". ' +
