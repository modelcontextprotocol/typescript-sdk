...
describe("resource()", () => {
  ...
  test("should remove resource and send notification when connected", async () => {
    ...
    // Removing a non-existent resource should return false but not send notification
...
describe("prompt()", () => {
  ...
  test("should remove prompt and send notification when connected", async () => {
    ...
    // Removing a non-existent prompt should return false but not send notification
    const notificationCount = notifications.length;
