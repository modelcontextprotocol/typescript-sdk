/**
 * @deprecated These extensible types with .passthrough() will be removed in a future version.
 * 
 * For better type safety, use the types from "./strictTypes.js" instead.
 * Those types use .strip() which provides compatibility with protocol extensions
 * while ensuring type safety by removing unknown fields.
 * 
 * Benefits of strictTypes.js:
 * - Type safety: Only known fields are included in the result
 * - No runtime errors: Unknown fields are silently stripped, not rejected
 * - Protocol compatible: Works with extended servers/clients
 * 
 * Migration guide:
 * - Change: import { ToolSchema } from "@modelcontextprotocol/sdk/types.js"
 * - To: import { ToolSchema } from "@modelcontextprotocol/sdk/strictTypes.js"
 */
