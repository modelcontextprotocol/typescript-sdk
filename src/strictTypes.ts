...
/**
 * @deprecated These extensible types with .strip() will be removed in a future version.
 * 
...
export const ClientCapabilitiesSchema = z
  .object({
     ...
     */
    sampling: z.optional(z.object({}).strip()),
    /**
     * Present if the client supports eliciting user input.
     */
    elicitation: z.optional(z.object({}).strip()),
    /**
...
export const ServerCapabilitiesSchema = z
  .object({
     ...
     */
    logging: z.optional(z.object({}).strip()),
    /**
     * Present if the server supports sending completions to the client.
     */
    completions: z.optional(z.object({}).strip()),
    /**
