...
export class StdioClientTransport implements Transport {
  ...
  set onmessage(onmessage: StdioClientTransport['_onmessage']) {
    this._onmessage = onmessage;
  }

  set onerror(onerror: StdioClientTransport['_onerror']) {
  ...
  set onclose(onclose: StdioClientTransport['_onclose']) {
