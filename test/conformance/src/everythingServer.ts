 ...
 * wiring only.
 *
 * Sibling: {@linkcode ./everythingServerHandleStatelessHttp.ts} drives the same registrations
 * via `handleStatelessHttp()` for the 2026-06 server-stateless conformance scenario.
 */
