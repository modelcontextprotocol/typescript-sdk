...
function testElicitationFlow(validatorProvider: typeof ajvProvider | typeof cfWorkerProvider, validatorName: string) {
    ...
    test(`${validatorName}: should elicit complex object with multiple fields`, async () => {
        ...
        const result = await server.legacy.elicitInput(formRequestParams);
    ...
    test(`${validatorName}: should reject invalid pattern`, async () => {
        ...
        await expect(server.legacy.elicitInput(formRequestParams)).rejects.toThrow(/does not match requested schema/);
    });
    ...
    test(`${validatorName}: should handle multiple sequential elicitation requests`, async () => {
        ...
        const nameResult = await server.legacy.elicitInput({
            mode: 'form',
            message: 'What is your name?',
            requestedSchema: {
                type: 'object',
        ...
        const ageResult = await server.legacy.elicitInput({
            message: 'What is your age?',
            requestedSchema: {
                type: 'object',
        ...
        const cityResult = await server.legacy.elicitInput({
