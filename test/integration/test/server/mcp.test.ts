...
describe('Zod v4', () => {
    ...
    // augmentation to enforce and no wrapper. Tool-level `execution.taskSupport` metadata
    // surfacing in `tools/list` is covered above ("should include execution field ...").
});
