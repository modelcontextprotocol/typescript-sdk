...
//   The client-to-server polling half (create / getTask / getTaskResult / listTasks) is
//   covered end-to-end by `taskLifecycle.test.ts` and `experimental/tasks/taskListing.test.ts`
//   via tasksPlugin. The server-to-client half (server polls client's tasks/*) is the
//   pattern SEP-2663 removes; that direction becomes MRTR (S3/F4), not tasks.
//
