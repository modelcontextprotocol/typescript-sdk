...
Every mode selects only among revisions in `ProtocolOptions.supportedProtocolVersions` —
the same option that pins what the legacy `initialize` handshake offers (see
