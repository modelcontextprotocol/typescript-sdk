...
- The extension is served on the 2026-07-28 revision. Task tools are ordinary tools without `outputSchema`; the encode seam forwards `resultType: "task"` for `tools/call` verbatim.
